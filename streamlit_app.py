...
st.title("🕷️ Crawl4AI Documentation Assistant")
...
if "feedback" not in st.session_state:
    st.session_state.feedback = {}  # message_index → True/False
...
if user_input:
    ...
    with st.chat_message("assistant"):
        ...
        # IMPROVED: Show "thinking" indicator while streaming starts
