...
* * *
  ...
  * [8. Extracting Sibling Data with source](https://docs.crawl4ai.com/extraction/no-llm-strategies/#sibling-data)
  * [9. Tips & Best Practices](https://docs.crawl4ai.com/extraction/no-llm-strategies/#9-tips-best-practices)
  * [10. Schema Generation Utility](https://docs.crawl4ai.com/extraction/no-llm-strategies/#10-schema-generation-utility)
  * [HTML Sample 2 (Product B):](https://docs.crawl4ai.com/extraction/no-llm-strategies/#html-sample-2-product-b)
  * [HTML Sample 3 (Product C):](https://docs.crawl4ai.com/extraction/no-llm-strategies/#html-sample-3-product-c)
  * [Provide instructions for stable selectors](https://docs.crawl4ai.com/extraction/no-llm-strategies/#provide-instructions-for-stable-selectors)
  * [Generate schema with multi-sample awareness](https://docs.crawl4ai.com/extraction/no-llm-strategies/#generate-schema-with-multi-sample-awareness)
  * [The generated schema will use stable selectors like:](https://docs.crawl4ai.com/extraction/no-llm-strategies/#the-generated-schema-will-use-stable-selectors-like)
  * [a[href*="/m/"] instead of tr:nth-child(6) td a](https://docs.crawl4ai.com/extraction/no-llm-strategies/#ahrefm-instead-of-trnth-child6-td-a)
  * [11. Conclusion](https://docs.crawl4ai.com/extraction/no-llm-strategies/#11-conclusion)
...
#### On this page
  ...
  * [7. Putting It All Together: Larger Example](https://docs.crawl4ai.com/extraction/no-llm-strategies/#7-putting-it-all-together-larger-example)
  * [8. Extracting Sibling Data with source](https://docs.crawl4ai.com/extraction/no-llm-strategies/#sibling-data)
  * [Syntax](https://docs.crawl4ai.com/extraction/no-llm-strategies/#syntax)
  * [Example: Hacker News](https://docs.crawl4ai.com/extraction/no-llm-strategies/#example-hacker-news)
  * [9. Tips & Best Practices](https://docs.crawl4ai.com/extraction/no-llm-strategies/#9-tips-best-practices)
  * [10. Schema Generation Utility](https://docs.crawl4ai.com/extraction/no-llm-strategies/#10-schema-generation-utility)
  * [Using the Schema Generator](https://docs.crawl4ai.com/extraction/no-llm-strategies/#using-the-schema-generator)
  * [Schema Validation](https://docs.crawl4ai.com/extraction/no-llm-strategies/#schema-validation)
  * [Token Usage Tracking](https://docs.crawl4ai.com/extraction/no-llm-strategies/#token-usage-tracking)
  ...
  * [Multi-Sample Schema Generation](https://docs.crawl4ai.com/extraction/no-llm-strategies/#multi-sample-schema-generation)
  * [HTML Sample 2 (Product B):](https://docs.crawl4ai.com/extraction/no-llm-strategies/#html-sample-2-product-b)
  * [HTML Sample 3 (Product C):](https://docs.crawl4ai.com/extraction/no-llm-strategies/#html-sample-3-product-c)
  * [11. Conclusion](https://docs.crawl4ai.com/extraction/no-llm-strategies/#11-conclusion)
